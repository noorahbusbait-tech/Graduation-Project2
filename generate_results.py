...
daily_occ['Admissions'] = daily_occ['Admissions'].fillna(daily_occ['Admissions'].median())
daily_occ['Admissions'] = daily_occ['Admissions'].fillna(0)

daily_occ['Occupancy'] = (
    daily_occ['Admissions'].fillna(0) * daily_occ['Avg_LOS'].fillna(daily_occ['Avg_LOS'].median())
).clip(upper=80)
